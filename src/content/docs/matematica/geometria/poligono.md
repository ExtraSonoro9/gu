...
Para cualquier polígono de $n$ lados, la suma de sus ángulos internos es:
$$S = (n - 2) \times 180^\circ$$
...
## 3. El Hexágono: Eficiencia Espacial
...
## 5. Relación con la Trigonometría
Para calcular materiales en una construcción poligonal:
1. Usamos el **Teorema de Pitágoras** para hallar alturas de triángulos.
2. Usamos el concepto de **Apotema** (la distancia del centro de un polígono regular al centro de un lado) para calcular el área:
$$Área = \frac{Perímetro \cdot Apotema}{2}$$
