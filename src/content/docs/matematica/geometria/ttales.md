...
## 3. Deducción de Ángulos en el Plano Inclinado
...
1. El vector Peso ($P$) es perpendicular a la línea del **horizonte**.
2. La recta Normal ($N$) es perpendicular a la **superficie del plano**.
3. Como el plano forma un ángulo $\alpha$ con la horizontal, el ángulo que se forma entre el Peso y la Normal es necesariamente **$\alpha$**.
