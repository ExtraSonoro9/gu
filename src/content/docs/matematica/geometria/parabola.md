...
* **Concavidad ($a$):** * Si $a > 0$, la parábola abre hacia arriba ($\cup$).
...
1.  **$\Delta > 0$:** La parábola corta al eje $X$ en **dos puntos** (raíces reales y distintas).
2.  **$\Delta = 0$:** La parábola toca al eje $X$ en **un solo punto** (el vértice es la única raíz).
3.  **$\Delta < 0$:** La parábola **no toca** el eje $X$ (raíces complejas/imaginarias).
...
* **En Cinemática:** El tiro parabólico. Si lanzas una pelota, su trayectoria sigue una función cuadrática donde $a$ es la gravedad:
...
* El eje de simetría de la parábola ($x_v$) está exactamente a la mitad de las dos raíces:
$$x_v = \frac{x_1 + x_2}{2}$$
Esto coincide con la fórmula de Vieta: $x_1 + x_2 = -b/a$.
