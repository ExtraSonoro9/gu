...
### 2. Series Infinitas
En la era del cálculo, se descubrieron formas de calcular $\pi$ sin dibujar círculos, usando sumas infinitas. Una de las más famosas (aunque lenta) es la de Leibniz:
...
1.  **Ondas y Sonido:** La descripción matemática de cualquier onda (luz, sonido, radio) utiliza funciones trigonométricas que dependen de $\pi$.
2.  **Probabilidad:** El famoso experimento de la **Aguja de Buffon** permite calcular $\pi$ simplemente lanzando agujas sobre una superficie rayada.
3.  **Relatividad General:** Einstein incluyó a $\pi$ en sus ecuaciones de campo para explicar cómo la masa y la energía curvan el espacio-tiempo.
