...
Se dice que una relación binaria 𝑓 ⊆ 𝐴 × 𝐵, con 𝐴 y 𝐵 conjuntos no vacíos, es una función parcial o aplicación parcial, y se denota 𝑓 ∶ 𝐴 → 𝐵, si 𝑓 no contiene dos pares ordenados distintos con la misma primera componente, es decir,

∀𝑎 ∈ 𝐴, ∀𝑏1, 𝑏2 ∈ 𝐵, si (𝑎, 𝑏1) ∈ 𝑓 y (𝑎, 𝑏2) ∈ 𝑓, entonces 𝑏1 = 𝑏2.

De manera más informal podemos decir que una función es una correspondencia entre los elementos de dos conjuntos 𝐴 y 𝐵 que asocia a cada elemento de 𝐴 un elemento, y solo uno, de 𝐵. 
...
Dada una función 𝑓 ∶ 𝐴 → 𝐵, se llama dominio de 𝑓, y se denota Dom(𝑓) al conjunto de las primeras componentes de los pares de 𝑓, es decir,

Dom(𝑓) = {𝑎 ∈ 𝐴 ∶ ∃𝑏 ∈ 𝐵, (𝑎, 𝑏) ∈ 𝑓}

# Imagen

Dada una función 𝑓 ∶ 𝐴 → 𝐵, se llama imagen de 𝑓, y se denota Im(𝑓) al conjunto de las segundas componentes de los pares de 𝑓, es decir,
