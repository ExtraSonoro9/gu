...
1. Usas el Teorema de Pitágoras: $1^2 + 1^2 = d^2$.
2. El resultado es $\sqrt{2}$.
3. **El problema:** Nunca terminarás de escribir el número exacto en milímetros ($1,4142...$). Por eso, en el mundo real, los ingenieros **redondean** (usan cifras significativas) para poder trabajar con números irracionales.
