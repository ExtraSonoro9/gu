...
1.  **Con Aire:** El objeto alcanza una **velocidad terminal** cuando $m \cdot g = \frac{1}{2} \rho v^2 C_D A$. El objeto deja de acelerar.
2.  **En el Vacío:** La única fuerza es el peso. La aceleración es constante ($g$).
    * **Ecuación:** $v = g \cdot t$
...
La intensidad sonora ($I$) disminuye con el cuadrado de la distancia ($r$):
$$I = \frac{P}{4\pi r^2}$$
*(Donde $P$ es la potencia de la fuente).*

### B. Atenuación por Absorción (Ecuación)
Para un análisis más técnico, la presión sonora ($p$) decae exponencialmente:
$$p(x) = p_0 \cdot e^{-\alpha x}$$
Donde:
