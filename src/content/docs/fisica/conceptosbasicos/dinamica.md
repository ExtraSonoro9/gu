...
2.  **Ley Fundamental de la Dinámica ($F = m \cdot a$):** La aceleración es proporcional a la fuerza neta e inversamente proporcional a la masa.
...
Un satélite se mantiene en órbita porque la **fuerza gravitatoria** de la Tierra actúa como su **fuerza centrípeta**.
$$G \frac{M \cdot m}{d^2} = m \frac{v^2}{d}$$
Esta igualdad es la que permite calcular la velocidad exacta a la que debe viajar un satélite para no caer ni salir disparado al espacio.