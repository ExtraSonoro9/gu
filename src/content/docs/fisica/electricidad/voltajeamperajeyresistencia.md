---
title: Voltaje, Amperaje y Resistencia
...
## 1. Los Tres Pilares Eléctricos

Para entender la ley, primero debemos definir sus componentes:

* **Voltaje ($V$):** También llamado diferencia de potencial. Es el "empuje" o la presión eléctrica que intenta mover las cargas. Se mide en **Voltios (V)**.
* **Intensidad o Amperaje ($I$):** Es el flujo real de carga (cuántos electrones pasan por un punto en un segundo). Se mide en **Amperios (A)**.
* **Resistencia ($R$):** Es la oposición que presenta un material al paso de la corriente. Se mide en **Ohmios ($\Omega$)**.
...
Si mantenemos el **Voltaje ($V$) constante**, la relación entre la Intensidad ($I$) y la Resistencia ($R$) es de **proporcionalidad inversa**.

### ¿Qué significa esto matemáticamente?
Cuando dos variables son inversamente proporcionales ($y = k/x$), su representación gráfica no es una línea recta, sino una **hipérbola equilátera**.
...
## 4. El "Triángulo" de la Ley de Ohm

| Relación | Tipo de Proporcionalidad | Efecto |
| :--- | :--- | :--- |
| **$I$ vs $V$** | Directa | Si doblas el voltaje, doblas la corriente. |
| **$I$ vs $R$** | Inversa | Si doblas la resistencia, la corriente se reduce a la mitad. |

---

## 5. Analogía Mecánica (La tubería)
...
## 6. Potencia Eléctrica (Ley de Joule)
